...
| participant descriptor | no direct equivalent | mode bits with SpendId | the commitment-value grammar naming an input's prevout data at a chosen precision (VALIDATION.md rule 3) |
