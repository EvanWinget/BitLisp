...
*Revised August 9, 2026 at the rule 5 costing decision: obligation 2's superlinear clause in section 7 amended to flat high pricing with a pre-registered Phase 4 revisit, decision 25 in `docs/condition-record.md`.*
